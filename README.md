# TickTrack – die WG-App

Werbefrei, kostenlos, Open Source. Mehr Infos auf unserer [Website](https://tick-track.app).
...
- [Dokumentation](https://tick-track.app/docs)
- [Server-Status](https://tick-track.app/status)
- [Nutzungsbedingungen](https://tick-track.app/terms)
- [Datenschutz](https://blvckleg.dev/app-legal)
